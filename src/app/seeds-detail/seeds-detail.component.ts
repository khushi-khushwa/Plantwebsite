...
@Component({
  selector: 'app-seeds-detail',
  templateUrl: './seeds-detail.component.html',
  styleUrls: ['./seeds-detail.component.scss']
})
export class SeedsDetailComponent implements OnInit {

  constructor( private activeroute:ActivatedRoute, 
        private seedItem:ApplyservicesService, 
